...
4. The infrastructure workflow verifies both images, assumes the target role, verifies the account, records SSM state, and temporarily updates both parameters.
